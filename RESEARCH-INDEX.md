...
| `*-disassembly-prompt.md` | Three self-contained handoffs: recover the GATT profile for a Gadgetbridge plugin; find injectable seams in the closed kernel for per-peripheral Rust replacement; disassemble the kernel dump in Ghidra. |
