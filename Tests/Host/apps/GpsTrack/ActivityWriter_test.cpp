 ...
 * @brief   Host tests for GpsTrack's ActivityWriter (native SDK::Fit encoder).
 ******************************************************************************
 */
...
TEST(GpsTrackActivityWriter, ProducesValidFitFileWithLapsAndGpsGating)
{
...
TEST(GpsTrackActivityWriter, DiscardRemovesTheFile)
{
    SDK::TestSupport::KernelFixture fx;
    ActivityWriter w(fx.kernel, "D:");
