/*
 * VENDORED into the AthensRun PoC from the fork branch
 * feat/rawtiles-container @ b957aa62 -- deliberately app-private (the PoC
 * charter: freeze no SDK surface while the rawtiles spec is v0.x). Do not
 * edit here; fix upstream on that branch and re-vendor.
 */
/**
 ******************************************************************************
 * @file    Container.hpp
