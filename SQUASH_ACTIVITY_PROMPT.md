...
**`simulator-imu-source`** (local + origin, HEAD `dd73e5f0`) is the enabling dependency. Merge or rebase it first (it also carries a real sensor-manager deadlock fix). It provides:
